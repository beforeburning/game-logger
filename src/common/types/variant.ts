...
type Variant6<A, B, C, D, E, F> = Record<string, A | B | C | D | E | F | undefined>;
...
// 处理异常 解析出枚举错误
export const throwsVariantError = (e: object) => {
...
// 取值
export const unwrapVariant = <T>(v: object | undefined, key: string): T | undefined => {
